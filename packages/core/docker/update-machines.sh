...
#   fly-app-name: e.g. crayon-dev-f7a3b2c1
#   image:        defaults to registry.fly.io/crayon-cloud-dev-image:latest
set -e

APP="${1:?Usage: $0 <fly-app-name> [image]}"
IMAGE="${2:-registry.fly.io/crayon-cloud-dev-image:latest}"
